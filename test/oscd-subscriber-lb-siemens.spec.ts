...
import type SubscriberLaterBindingNR from '../oscd-subscriber-lb-nr.js';
...
const plugins = {
  menu: [
    {
      name: 'Subscriber Later Binding - NR',
      translations: {
      ...
      active: true,
      requireDoc: true,
      src: '/dist/oscd-subscriber-lb-nr.js',
    },
    {
      name: 'Mock Subscriber Later Binding',
      icon: 'autorenew',
      active: true,
      requireDoc: true,
      src: '/dist/test/mock-subscriber-lb.js',
    },
  ],
};
...
const plugin: SubscriberLaterBindingNR = document
  .querySelector('open-scd')!
  .shadowRoot!.querySelector<SubscriberLaterBindingNR>('aside > :last-child')!;
